...
public final class TnetStatusCode {
    ...
    public static final int getStatusCode(int i) {
        return i <= -3500 ? EASY_REASON_SLIGHTSSL_ERROR : i <= -3000 ? EASY_REASON_HANDSHAKE_ERROR : i <= -2500 ? EASY_REASON_CONN_ERROR : i <= -2300 ? EASY_REASON_WRITE_ERROR : i <= -2100 ? EASY_REASON_READ_ERROR : i;
    }
