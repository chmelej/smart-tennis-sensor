...
/* JADX INFO: renamed from: cn.sharesdk.tencent.qzone.a */
/* JADX INFO: compiled from: QZoneAuthorizeWebviewClient.java */
/* JADX INFO: loaded from: classes.dex */
public class C0884a extends AbstractC0823b {
    public C0884a(C0826e c0826e) {
        super(c0826e);
    }
    ...
    protected void m6370a(String str) {
        if (str.startsWith(this.f5548b)) {
    ...
    /* JADX INFO: renamed from: a */
    private void m6369a(HashMap<String, String> map) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                HashMap<String, Object> mapM6386e = C0885b.m6371a(this.f5547a.m5982a().getPlatform()).m6386e(str);
                if (mapM6386e != null && mapM6386e.size() > 0) {
                    if (!mapM6386e.containsKey("openid")) {
                        if (this.f5549c != null) {
                    ...
                    bundle.putString("open_id", String.valueOf(mapM6386e.get("openid")));
