...
/* JADX INFO: renamed from: cn.sharesdk.framework.d */
/* JADX INFO: compiled from: SSDKWebViewClient.java */
/* JADX INFO: loaded from: classes.dex */
public class C0845d extends WebViewClient {
    ...
    public void onReceivedSslError(WebView webView, final SslErrorHandler sslErrorHandler, SslError sslError) {
        ...
        if (webView.getContext() instanceof Activity) {
            ...
            builder.setPositiveButton(strValueOf2, new DialogInterface.OnClickListener() { // from class: cn.sharesdk.framework.d.1
            ...
            builder.setNegativeButton(strValueOf3, new DialogInterface.OnClickListener() { // from class: cn.sharesdk.framework.d.2
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    dialogInterface.dismiss();
