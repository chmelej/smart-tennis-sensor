...
class LoaderManagerImpl extends LoaderManager {
    ...
    private final InterfaceC1816j mLifecycleOwner;
    private final LoaderViewModel mLoaderViewModel;

    public static class LoaderInfo<D> extends C1959o<D> implements Loader.OnLoadCompleteListener<D> {
        private final Bundle mArgs;
        private final int mId;
        private InterfaceC1816j mLifecycleOwner;
        ...
        Loader<D> setCallback(InterfaceC1816j interfaceC1816j, LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
            LoaderObserver<D> loaderObserver = new LoaderObserver<>(this.mLoader, loaderCallbacks);
            observe(interfaceC1816j, loaderObserver);
            if (this.mObserver != null) {
                removeObserver(this.mObserver);
            }
            this.mLifecycleOwner = interfaceC1816j;
            this.mObserver = loaderObserver;
            return this.mLoader;
        }

        void markForRedelivery() {
            InterfaceC1816j interfaceC1816j = this.mLifecycleOwner;
            LoaderObserver<D> loaderObserver = this.mObserver;
            if (interfaceC1816j == null || loaderObserver == null) {
                return;
            }
        ...
        @Override // android.arch.lifecycle.LiveData
        public void removeObserver(InterfaceC2014p<? super D> interfaceC2014p) {
            super.removeObserver(interfaceC2014p);
        ...
        @Override // p000.C1959o, android.arch.lifecycle.LiveData
    ...
    static class LoaderObserver<D> implements InterfaceC2014p<D> {
    ...
    static class LoaderViewModel extends AbstractC2070r {
        private static final C2097s.a FACTORY = new C2097s.a() { // from class: android.support.v4.app.LoaderManagerImpl.LoaderViewModel.1
            @Override // p000.C2097s.a
            public <T extends AbstractC2070r> T create(Class<T> cls) {
        ...
        static LoaderViewModel getInstance(C2124t c2124t) {
            return (LoaderViewModel) new C2097s(c2124t, FACTORY).m11505a(LoaderViewModel.class);
        }
    ...
    LoaderManagerImpl(InterfaceC1816j interfaceC1816j, C2124t c2124t) {
        this.mLifecycleOwner = interfaceC1816j;
        this.mLoaderViewModel = LoaderViewModel.getInstance(c2124t);
    }
