...
public class FragmentActivity extends SupportActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator, InterfaceC2151u {
    ...
    private C2124t mViewModelStore;
    ...
    @Override // android.support.v4.app.SupportActivity, p000.InterfaceC1816j
    ...
    private void markFragmentsCreated() {
        while (markState(getSupportFragmentManager(), AbstractC1762h.b.CREATED)) {
        }
    }

    private static boolean markState(FragmentManager fragmentManager, AbstractC1762h.b bVar) {
        boolean zMarkState = false;
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                if (fragment.getLifecycle().mo9592a().m9595a(AbstractC1762h.b.STARTED)) {
                    fragment.mLifecycleRegistry.m10071a(bVar);
                    zMarkState = true;
                }
