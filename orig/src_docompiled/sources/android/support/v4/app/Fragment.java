...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, InterfaceC1816j, InterfaceC2151u {
    ...
    View mView;
    InterfaceC1816j mViewLifecycleOwner;
    C1843k mViewLifecycleRegistry;
    C2124t mViewModelStore;
    String mWho;
    ...
    C1843k mLifecycleRegistry = new C1843k(this);
    C1959o<InterfaceC1816j> mViewLifecycleOwnerLiveData = new C1959o<>();
    ...
    @Override // p000.InterfaceC1816j
    public AbstractC1762h getLifecycle() {
        return this.mLifecycleRegistry;
    }

    public InterfaceC1816j getViewLifecycleOwner() {
    ...
    public LiveData<InterfaceC1816j> getViewLifecycleOwnerLiveData() {
        return this.mViewLifecycleOwnerLiveData;
    }

    @Override // p000.InterfaceC2151u
    public C2124t getViewModelStore() {
        if (getContext() == null) {
            throw new IllegalStateException("Can't access ViewModels from detached fragment");
        }
        if (this.mViewModelStore == null) {
            this.mViewModelStore = new C2124t();
        }
    ...
    final void restoreViewState(Bundle bundle) {
        ...
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_CREATE);
        }
    }
    ...
    void performCreate(Bundle bundle) {
        ...
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_CREATE);
    }
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new InterfaceC1816j() { // from class: android.support.v4.app.Fragment.3
            @Override // p000.InterfaceC1816j
            public AbstractC1762h getLifecycle() {
                if (Fragment.this.mViewLifecycleRegistry == null) {
                    Fragment.this.mViewLifecycleRegistry = new C1843k(Fragment.this.mViewLifecycleOwner);
                }
    ...
    void performStart() {
        ...
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_START);
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_START);
        }
    }
    ...
    void performResume() {
        ...
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_RESUME);
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_RESUME);
        }
    }
    ...
    void performPause() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_PAUSE);
        }
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_PAUSE);
        if (this.mChildFragmentManager != null) {
    ...
    void performStop() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_STOP);
        }
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_STOP);
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroyView() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.m10070a(AbstractC1762h.a.ON_DESTROY);
        }
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroy() {
        this.mLifecycleRegistry.m10070a(AbstractC1762h.a.ON_DESTROY);
        if (this.mChildFragmentManager != null) {
