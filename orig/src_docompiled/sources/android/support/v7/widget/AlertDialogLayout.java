...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean m3499c(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM3498c = m3498c(view2);
            measuredHeight = view2.getMeasuredHeight() - iM3498c;
            paddingTop += iM3498c;
        ...
        if (view2 != null) {
            int i5 = paddingTop - iM3498c;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM3498c += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM3498c, 1073741824));
        ...
        m3500d(childCount, i2);
        return true;
    }

    /* JADX INFO: renamed from: d */
    private void m3500d(int i, int i2) {
    ...
    /* JADX INFO: renamed from: c */
    private static int m3498c(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m3498c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                m3497a(childAt, i5, i11, measuredWidth, measuredHeight2);
    ...
    private void m3497a(View view, int i, int i2, int i3, int i4) {
