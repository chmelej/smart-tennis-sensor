...
public class UIHandler {
    ...
    private static void printPray() {
        try {
            byte[] bArrDecode = Base64.decode(PRAYS[Math.abs(new Random().nextInt()) % 3], 2);
            MobLog.getInstance().m8609d("\n" + new String(bArrDecode, "utf-8"), new Object[0]);
        } catch (Throwable th) {
