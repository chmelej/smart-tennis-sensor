    ...
    static class EasingFunctions {
        ...
        public static final EasingFunction EaseInOutExpo = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.16
            ...
            public float getInterpolation(float f) {
                ...
                if (f / 0.5f < 1.0f) {
                    return ((float) Math.pow(2.0d, (r8 - 1.0f) * 10.0f)) * 0.5f;
                }
                return ((-((float) Math.pow(2.0d, (r8 - 1.0f) * (-10.0f)))) + 2.0f) * 0.5f;
            }
        };
        ...
        public static final EasingFunction EaseInOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.22
            ...
            public float getInterpolation(float f) {
                ...
                if (f2 < 1.0f) {
                    return ((float) Math.pow(2.0d, 10.0f * r12)) * ((float) Math.sin((((double) (((f2 - 1.0f) * 1.0f) - fAsin)) * 6.283185307179586d) / ((double) 0.45000002f))) * (-0.5f);
                }
                return (((float) Math.pow(2.0d, (-10.0f) * r12)) * ((float) Math.sin((((double) (((f2 - 1.0f) * 1.0f) - fAsin)) * 6.283185307179586d) / ((double) 0.45000002f))) * 0.5f) + 1.0f;
            }
        };
